...
def sidebar_filters(df: pd.DataFrame) -> dict:
    ...
    prefixadas por 'sidebar_' para cada widget.
    """
...
def main():
    ...
    with st.expander("📋 Tabela Interativa", expanded=False):
        ...
        AgGrid(df_f.drop(columns=["Descricao_Equip"]), gridOptions=gb.build(), height=400)
